...
export class PoliciesPanel {
    ...
    static createOrShow() {
        ...
        const panel = vscode.window.createWebviewPanel('aikernel.policies', 'AI Kernel - Políticas', vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
...
<html lang="pt-BR"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">${CSP}<title>Políticas</title>
