...
public sealed class OpenQACommand
{
    ...
    private OpenQACommand(AsyncPackage package, OleMenuCommandService commandService)
    {
        _package = package;
    ...
    public static async Task InitializeAsync(AsyncPackage package)
    {
        ...
        {
            _ = new OpenQACommand(package, commandService);
        }
    }
    ...
    private void Execute(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                await _package.ShowToolWindowAsync(typeof(QAToolWindow), 0, true, _package.DisposalToken);
            });
        }
        catch (Exception ex)
        {
